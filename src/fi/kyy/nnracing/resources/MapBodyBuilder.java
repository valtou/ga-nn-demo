...
public class MapBodyBuilder {
    ...
    public static Array<Body> buildBounds(Map map, float pixels, World world) {
        ppt = pixels;
        MapObjects objects = map.getLayers().get("Bounds").getObjects();
    ...
    public static Array<Body> buildCheckpoints(Map map, float pixels, World world) {
    	  ppt = pixels;
          MapObjects objects = map.getLayers().get("Checkpoints").getObjects();
          Array<Body> bodies = new Array<Body>();
          int i = 0;
